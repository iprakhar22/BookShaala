...
<html lang="en">
  <head>
    ...
    <title>BookShaala: Request A Book </title>
  ...
  <body>
    ...
    <div class="pageTitle jumbotron">
      ...
      <div class="container">
        <p></p>
        <p>Cannot find the book you were looking for in our search section? No problem. Just ask for your favorite book and we will get it for you.</p>
      </div>
    </div>
      ...
      <div class="container">
        <form action="php/request_backend.php" method="post" enctype="multipart/form-data" >
          ...
          <div class="form-group">
            <label >Name:</label>
            <input class="form-control" name="name" placeholder="Enter Book Name">
          </div>
